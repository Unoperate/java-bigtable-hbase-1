...
public class DefaultAppender implements Appender {
  ...
  public static final String PREFIX_PATH_KEY = "google.bigtable.mirroring.appender.prefix-path";
  public static final String MAX_BUFFER_SIZE_KEY =
      "google.bigtable.mirroring.appender.max-buffer-size";
  public static final String DROP_ON_OVERFLOW_KEY =
      "google.bigtable.mirroring.appender.drop-on-overflow";
  ...
  private static boolean getDropOnOverflowFromConfiguration(Configuration configuration) {
    String dropOnOverflow = configuration.get(DROP_ON_OVERFLOW_KEY);
  ...
  private static int getMaxBufferSizeFromConfiguration(Configuration configuration) {
    String maxBufferSize = configuration.get(MAX_BUFFER_SIZE_KEY);
    Preconditions.checkArgument(
