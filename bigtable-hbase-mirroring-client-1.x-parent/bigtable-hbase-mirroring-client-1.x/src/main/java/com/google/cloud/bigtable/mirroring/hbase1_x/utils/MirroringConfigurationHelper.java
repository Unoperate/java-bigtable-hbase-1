...
public class MirroringConfigurationHelper {
   ...
   *
   * <ul>
   *   <li>NONE - disabled, leads to inconsistencies between mirrored databases because timestamps
   *       are assigned separately on databases' severs.
   *   <li>IN_PLACE - all mutations without timestamp are modified in place and have timestamps
